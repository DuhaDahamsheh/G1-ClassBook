...
const Page4 = () => {
    ...
    const activeData = [
        ...
        { page: "2", title: ["Goodbye", " How are you?", " Fine", "thank you ", " Hello ", "Good morning"], sound: vocabulary, imgSrc: "" },
        { page: "3", title: "Lestine and read along", sound: listenSound, imgSrc: listenImg }
    ]
        ...
        <>
            <div className='page_4-background' >
                ...
                <span className='headset-icon-CD-page4-1 shadow-md hover:scale-110 transition'>
                    <FaHeadphones size={12} color="rgba(255, 255, 255, 1)" onClick={() => setActivePopup(1)} />
                ...
                <span className='headset-icon-CD-page4-2 shadow-md hover:scale-110 transition'>
                    <FaHeadphones size={12} color="rgba(255, 255, 255, 1)" onClick={() => setActivePopup(2)} />
                ...
                <Popup
                    ...
                    children={
                        <>
                            <header className='header-title-page4'>{activeData[2].title}</header>
                            <img src={activeData[2].imgSrc} style={{ height: "auto", width: "700px" }} />
