...
const Page7 = () => {
  ...
  const clickableAreas = [
    ...
    { x1: 9.00, y1: 17.00, x2: 33.00, y2: 21.00, sound: Pg7_3_1_Stella },
    { x1: 21.00, y1: 40.00, x2: 42.17, y2: 44.00, sound: Pg7_3_2_Mom },
    { x1: 50.00, y1: 20.18, x2: 70.00, y2: 24.00, sound: Pg7_4_1_Hansel },
    { x1: 69.25, y1: 47.00, x2: 89.02, y2: 50.00, sound: Pg7_4_2_ModifiedJack },
    { x1: 9.00, y1: 57.00, x2: 27.02, y2: 59.00, sound: Pg7_5_1_Dad },
    { x1: 30.00, y1: 47.50, x2:46.00, y2: 62.00, sound: Pg7_5_2_Mom },
