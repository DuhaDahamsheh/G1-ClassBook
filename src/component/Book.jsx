    ...
    <div className="w-full min-h-screen flex items-center justify-center relative">
      ...
      {isMobile ? (
        <>
          <button
            onClick={prevPage}
            className="absolute left-4 w-10 h-10 rounded-full bg-[#5247DD] text-white flex items-center justify-center shadow-md hover:scale-110 transition"
          >
          ...
          <button
            onClick={nextPage}
            className="absolute right-4 w-10 h-10 rounded-full bg-[#5247DD] text-white flex items-center justify-center shadow-md hover:scale-110 transition z-[9999]"
          >
            <GrLinkNext size={25} />
          </button>
        </>
      ...
      pageIndex === 0 ? (
        <>
          ...
          <button
            onClick={nextPage}
            className="absolute right-8 w-14 h-14 rounded-full bg-[#5247DD] text-white flex items-center justify-center shadow-md hover:scale-110 transition z-[9999]"
          >
            <GrLinkNext size={25} />
          </button>
        </>
        ...
        <>
          <button
            onClick={prevPage}
            className="absolute left-8 w-14 h-14 rounded-full bg-[#5247DD] text-white flex items-center justify-center shadow-md hover:scale-110 transition z-[9999]"
          >
